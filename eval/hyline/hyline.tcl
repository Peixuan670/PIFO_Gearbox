set myAgent "Agent/TCP/FullTcp/Sack/SolTCP/Ctr";
set switchAlg "RPQ"
set hybrid 1
...
set num_queue 2;#[lindex $argv 1]
set cap0 [lindex $argv 1] 
set size_queue 226 
set pfc [lindex $argv 2] 
set margin_ 10 ;#[lindex $argv 4]
set Elp_win_init_ [lindex $argv 3]
set Elp_min_rto  [lindex $argv 4]
set min_deadline_offset 0.5
#set max_deadline_offset [lindex $argv 6]
set ld [lindex $argv 5]
...
set pfc_thr1_host_edg $pfc_thr1_edg_agg ;#[lindex $argv 7]
...
set flowlog [open hyline_flow_$num_flow\_$cap0\_$pfc\_$Elp_win_init_\_$Elp_min_rto\_$ld\_$top.tr w]
...
set pktSize 1460
set slowstartrestart 0
set min_rto 0.004;#0.0002 ==>40X pfabric 
set ackRatio 1
set enableHRTimer 0
...
Queue/RPQ set size_0 $queueSize
if {$pfc==1} {
	Queue/RPQ set size_1 [expr $queueSize+100]
} else {
	 Queue/RPQ set size_1 $queueSize
...
#source "/home/student/Desktop/common/Topology-singlepath.tcl"
#source "/home/student/Desktop/common/top-single-ab.tcl"
