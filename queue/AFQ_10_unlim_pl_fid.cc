...
static class AFQ_10_unlim_plClass : public TclClass {
public:
        AFQ_10_unlim_plClass() : TclClass("Queue/AFQ10UlimPL") {}
        TclObject* create(int, const char*const*) {
            fprintf(stderr, "Created new TCL AFQ10UlimPL instance\n"); // Debug: Peixuan 07062019
	        return (new AFQ_10_unlim_pl);
	}
} class_AFQ10;
...
int AFQ_10_unlim_pl::cal_theory_departure_round(hdr_ip* iph, int pkt_size) {
    //int		fid_;	/* flow id */
    //int		prio_;
    // parameters in iph
    // TODO
...
vector<Packet*> AFQ_10_unlim_pl::runRound() {
